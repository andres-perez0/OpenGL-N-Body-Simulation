...
struct simulation {
    ...
    void initilaize() {
        ...
        // objects.emplace_back(new body(glm::vec2 (3.0f * SCR_WIDTH/4.0f, SCR_HEIGHT/3.0f), 10.0f, glm::vec3(1.0f, 1.0f, 1.0f)));
        ...
        // objects.emplace_back(new body(glm::vec2 (SCR_WIDTH/4.0f, SCR_HEIGHT/3.0f), 10.0f, glm::vec3(1.0f, 1.0f, 1.0f)));
    }
